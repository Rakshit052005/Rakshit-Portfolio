          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:rakshitgarg897@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    rakshitgarg897@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/rakshit-garg-2597a0270/" target="_blank">
                  <Linkedin />
                </a>
               
                <a href="https://www.instagram.com/rakshitgarg0505/" target="_blank">
                  <Instagram />
                </a>
              </div>
            </div>
